...
class PromptEncoder(nn.Module):
    ...
    def get_dense_pe(self) -> torch.Tensor:
        """Returns the positional encoding used to encode point prompts, applied to a dense set of
        points the shape of the image encoding.
    ...
    def _embed_boxes(
        self, boxes: torch.Tensor, input_image_size: Tuple[int, int, int]
    ) -> torch.Tensor:
        """Embeds box prompts."""
