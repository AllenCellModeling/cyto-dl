# modified from https://github.com/kevinjohncutler/omnipose/blob/main/omnipose/core.py
import warnings
...
class OmniposeRandFlipd(RandomizableTransform):
    """Flipping Augmentation for Omnipose training.

    When flipping ground truths generated by `OmniposePreprocessD, the sign of gradients have to be
    ...
    def __init__(
        ...
        --------------
        label_keys:Union[str, Sequence[str]]
            key or list of keys generated by OmniposePreprocessD to flip
        image_keys:Union[str, Sequence[str]]
            key or list of keys NOT generated by OmniposePreprocessd to flip
        spatial_axis:int
            axis to flip across
        prob:float=0.1
    ...
    def _flip(self, img, is_label):
        if is_label:
            ...
            flipped_flows[self.spatial_dims] *= -1
