...
- https://github.com/SimingYan/IAE/blob/main/src/dfnet/models/decoder.py
"""
...
from .graph_functions import normalize_3d_coordinate, normalize_coordinate


class LocalDecoder(nn.Module):
    """Decoder. Instead of conditioning on global features, on plane/volume local features.
