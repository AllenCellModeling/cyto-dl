...
class H_Encoder(nn.Module):
    ...
    def __init__(self, 
    mask_ratio, encoder_depths, encoder_dims, local_radius,drop_path_rate, num_heads, **kwargs):
        super().__init__()
        self.config = config
...
class Point_M2AE(nn.Module):
    ...
    def __init__(self,drop_path_rate,num_heads, decoder_up_blocks, decoder_dims, decoder_depths,group_sizes, num_groups, mask_ratio, encoder_depths, encoder_dims, local_radius,drop_path_rate, num_heads):
        super().__init__()
        ...
        # hierarchical encoder
        self.h_encoder = H_Encoder(mask_ratio, encoder_depths, encoder_dims, local_radius,drop_path_rate, num_heads)
