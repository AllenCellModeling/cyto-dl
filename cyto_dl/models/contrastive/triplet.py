...
class Triplet(BaseModel):
    ...
    def model_step(self, stage, batch, batch_idx):
        ...
        if stage == 'val' and batch_idx==0:
            print('AVG HARD NEGATIVE DISTANCE:', pairwise_dist[torch.arange(pairwise_dist.shape[0]), hard_negative_idx].mean())
            print('AVG HARD POSITIVE DISTANCE:', pairwise_dist[torch.arange(pairwise_dist.shape[0]), hard_positive_idx].mean())
