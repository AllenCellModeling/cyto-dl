...
def load_model_from_checkpoint(tracking_uri, run_id, strict=True, path="checkpoints/last.ckpt", map_location=None):
    mlflow.set_tracking_uri(tracking_uri)
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        return model_class.load_from_checkpoint(ckpt_path, **model_conf, map_location=map_location, strict=strict).eval()
