...
# Install PyTorch with CUDA 13.0 support (recommended for GPU training on Windows/Linux)
# Note: Works on both Windows and Linux. Use uv for faster installation.
